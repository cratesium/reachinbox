...
const transporter = nodemailer.createTransport({
  ...
  async function generateEmailContent(label) {
    ...
    switch (label) {
      case 'Interested':
        prompt = 'The user is interested. Please write an email thanking them for their interest and proposing a convenient time for a briefing call. Keep the email around 100 words.';
        break;
      case 'Not Interested':
        prompt = 'The user is not interested. Please write an email thanking them for their time and asking for any feedback or suggestions they may have. Keep the email around 100 words.';
        break;
      case 'More Information':
        prompt = 'The user requests more information. Please write an email expressing gratitude for their interest and asking what specific details they need. Keep the email around 100 words.';
        break;
      default:
        prompt = '';
    }
  ...
  async function generateReplyContent(label) {
    ...
    switch (label) {
      case 'Interested':
        ...
        break;
      case 'Not Interested':
        prompt = 'Thank you for considering our offer. We respect your decision. If you have any feedback or suggestions for improvement, we\'d love to hear from you.';
        break;
      case 'More Information':
        prompt = 'We understand you need more information. Thank you for reaching out. Could you please specify the details you\'re looking for so we can assist you better?';
        break;
      default:
        prompt = '';
    }
